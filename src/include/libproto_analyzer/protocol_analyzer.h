...
void pa_set_protocol_data(uint32_t data, uint8_t byte_pos, uint8_t bit_pos, uint16_t len,uint8_t *dp);
...
void pa_get_protocol_data(proto_info_list_t *info_list, struct protocol_analyzer_s *pa);
