...
#define DBG_CONTAINER_DBG_PANIC		 DBG_BUSINESS_CONTAINER << 8 | DBG_DBG_PANIC 
#define DBG_CONTAINER_FATAL			 DBG_BUSINESS_CONTAINER << 8 | DBG_FATAL 
#define DBG_CONTAINER_ERROR			 DBG_BUSINESS_CONTAINER << 8 | DBG_ERROR 
#define DBG_CONTAINER_WARNNING		 DBG_BUSINESS_CONTAINER << 8 | DBG_WARNNING 
#define DBG_CONTAINER_SUC			 DBG_BUSINESS_CONTAINER << 8 | DBG_SUC 
#define DBG_CONTAINER_CORRECT		 DBG_BUSINESS_CONTAINER << 8 | DBG_CORRECT 
#define DBG_CONTAINER_VIP 		  	 DBG_BUSINESS_CONTAINER << 8 | DBG_VIP 
#define DBG_CONTAINER_FLOW			 DBG_BUSINESS_CONTAINER << 8 | DBG_FLOW 
#define DBG_CONTAINER_IMPORTANT		 DBG_BUSINESS_CONTAINER << 8 | DBG_IMPORTANT 
#define DBG_CONTAINER_DETAIL		 DBG_BUSINESS_CONTAINER << 8 | DBG_DETAIL 
