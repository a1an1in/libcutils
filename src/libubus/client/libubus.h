...
struct ubus_context {
    ...
    client_t *client;
    uint8_t client_type;
#define UBUS_CONTEXT_MAX_STR_LEN 50
    char client_id_str[UBUS_CONTEXT_MAX_STR_LEN];
    char client_server_str[UBUS_CONTEXT_MAX_STR_LEN];
#undef UBUS_CONTEXT_MAX_STR_LEN
};
